...
disallowed_tools: mcp__mina-harness__perf_compare, mcp__mina-harness__perf_measure, mcp__mina-harness__bug_report_file, mcp__mina-harness__bug_report_bundle, Bash(git push *), Bash(git push), Bash(gh pr *), Bash(gh repo *), NotebookEdit, WebFetch, WebSearch, Agent, Task
