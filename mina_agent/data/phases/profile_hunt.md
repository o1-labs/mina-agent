...
disallowed_tools: mcp__mina-harness__perf_compare, mcp__mina-harness__bug_report_file, mcp__mina-harness__bug_report_bundle, Bash, Write, NotebookEdit, WebFetch, WebSearch, Agent, Task
